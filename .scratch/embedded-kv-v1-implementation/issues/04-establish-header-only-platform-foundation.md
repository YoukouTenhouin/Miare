...
- [ ] XChaCha20-Poly1305-IETF, keyed BLAKE2b-256 and the BLAKE2b KDF, secure randomness, and Zstandard provider adapters enforce input, output, memory, nonce, derivation, and authentication bounds.
